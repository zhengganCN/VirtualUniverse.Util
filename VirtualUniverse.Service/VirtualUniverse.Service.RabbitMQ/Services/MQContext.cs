...
************************************************************************************/
namespace VirtualUniverse.Service.RabbitMQ.Services
{
    /// <summary>
    /// 类说明：MQ上下文
    /// </summary>
    public abstract class MQContext
    {
        ...
        private static Dictionary<string, QueueDeclareOk> QueueDictionaries { get; set; } = new Dictionary<string, QueueDeclareOk>();
        ...
        private void CreateQueue(string queueName)
        {
            ...
            {
                QueueDictionaries.Add(queueName, Channel.QueueDeclare(queueName, false, false, false, null));
            }
        }
        /// <summary>
