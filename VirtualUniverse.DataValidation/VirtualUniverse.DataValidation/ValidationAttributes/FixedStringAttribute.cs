...
namespace VirtualUniverse.DataValidation.ValidationAttributes
{
    ...
    public sealed class FixedStringAttribute : ValidationAttribute
    {
        ...
        public FixedStringAttribute(object[] allowObjects, EnumObjectType objectType = EnumObjectType.String)
        {
